...
public class CopyOfMainActivity_2_5_2014 extends ListActivity {
			...
			if (bundle.containsKey("handleUpdate")) {
				...
				try {
					...
					for (int i = 0; i < jsonArray.length(); i++) {
						...
						arrUpdateVersion[i] = new UpdateVersion(CopyOfMainActivity_2_5_2014.this, url_version, packageName_version, appname_version, parentHandler);
				...
				if (count == arrUpdateVersion.length && !checkUpdateValid()) {
					CopyOfMainActivity_2_5_2014.this.finish();
				}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!checkOnlineState()) {
			...
			// launcher = new UpdateVersion(this, Config.URL_VERSION_LAUNCHER,
			// Config.PACKAGE_LAUNCHER, Config.APP_LAUNCHER, parentHandler);
			// version = new UpdateVersion(this, Config.URL_VERSION_PROXY,
			// Config.PACKAGE_PROXY, Config.APP_PROXY, parentHandler);
			...
			// "------- dang xu ly update: " + launcher.isLoaded() + " - " +
			// version.isLoaded());
			// if (launcher.isLoaded() && version.isLoaded()) {
			// timer.cancel();
			// removeOtherApps();
			// }
			//
	...
	public void removeOtherApps() {
		...
		for (ApplicationInfo packageInfo : packages) {
			...
			if (runningPkgNames.contains(packageInfo.packageName)) {
				// if(appName != null) {
				// AppInfo appInfo = new AppInfo(appName.toString(),
	...
	public void handleUrl() {
		...
		// String url_use = server;
		
		
//		boolean redirectToLauncher = redirectToLauncher(server);
//		if (redirectToLauncher) {
//			this.finish();
//			return;
//		}
...
//			}
			...
			if (this.channelNum != null) {
				...
				Log.e("TAG: " + CopyOfMainActivity_2_5_2014.class.getSimpleName(), "channelNum: " + channelNum + " url: " + url_use);
...
//					removeOtherApps();
					...
					// getSharedPreferences("com.vp9.app",
					// Context.MODE_PRIVATE);
					// String restoredUrl = prefs.getString("url", null);
					// if(restoredUrl != null){
					// Intent intent = new Intent(getBaseContext(),
					// VpMainActivity.class);
					// intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
					// intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					// intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					// Bundle bundle=new Bundle();
...
//		super.onDestroy();
	...
	public void onPause() {
		...
		// timer.cancel();
		// }
		Log.d(CopyOfMainActivity_2_5_2014.class.getSimpleName(), "onpause");
		// this.finish();
		// if(_alert != null){
		// _alert.dismiss();
		// }
	...
	protected void onStop() {
		...
		Log.d(CopyOfMainActivity_2_5_2014.class.getSimpleName(), "onstop");
		super.onStop();
	}
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		Log.d(CopyOfMainActivity_2_5_2014.class.getSimpleName(), "ondestroy");
		super.onDestroy();
	}
}
