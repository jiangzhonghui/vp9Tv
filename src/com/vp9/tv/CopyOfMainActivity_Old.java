...
public class CopyOfMainActivity_Old extends ListActivity {
			...
			if (bundle.containsKey("handleUpdate")) {
				...
				try {
					...
					for (int i = 0; i < jsonArray.length(); i++) {
						...
						arrUpdateVersion[i] = new UpdateVersion(CopyOfMainActivity_Old.this, url_version, packageName_version, appname_version, parentHandler);
				...
				if (count == arrUpdateVersion.length && !checkUpdateValid()) {
					CopyOfMainActivity_Old.this.finish();
				}
...
//			}
			...
			if (this.channelNum != null) {
				...
				Log.e("TAG: " + CopyOfMainActivity_Old.class.getSimpleName(), "channelNum: " + channelNum + " url: " + url_use);
...
//		super.onDestroy();
	...
	public void onPause() {
		...
		// timer.cancel();
		// }
		Log.d(CopyOfMainActivity_Old.class.getSimpleName(), "onpause");
		// this.finish();
		// if(_alert != null){
		// _alert.dismiss();
		// }
	...
	protected void onStop() {
		...
		Log.d(CopyOfMainActivity_Old.class.getSimpleName(), "onstop");
		super.onStop();
	}
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		Log.d(CopyOfMainActivity_Old.class.getSimpleName(), "ondestroy");
		super.onDestroy();
	}
}
