...
public class CopyOfMainActivity_New extends ListActivity {
			...
			if (bundle.containsKey("handleUpdate")) {
				...
				try {
					...
					for (int i = 0; i < jsonArray.length(); i++) {
						...
						arrUpdateVersion[i] = new UpdateVersion(CopyOfMainActivity_New.this, url_version, packageName_version, appname_version, parentHandler);
...
//			}
			...
			if (this.channelNum != null) {
				...
				Log.e("TAG: " + CopyOfMainActivity_New.class.getSimpleName(), "channelNum: " + channelNum + " url: " + url_use);
...
//					removeOtherApps();
	...
	public void onPause() {
		...
		// timer.cancel();
		// }
		Log.d(CopyOfMainActivity_New.class.getSimpleName(), "onpause");
		// this.finish();
		// if(_alert != null){
		// _alert.dismiss();
		// }
	...
	protected void onStop() {
		...
		Log.d(CopyOfMainActivity_New.class.getSimpleName(), "onstop");
		finish();
		super.onStop();
	}
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		Log.d(CopyOfMainActivity_New.class.getSimpleName(), "ondestroy");
		exitApp();
		super.onDestroy();
