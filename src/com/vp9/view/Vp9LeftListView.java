...
public class Vp9LeftListView extends ListView{

	private static final String TAG = "Vp9LeftListView";
	...
	public Vp9LeftListView(Context context) {
		super(context, null);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	...
    	if(friendListView != null && ((Vp9RightListView)friendListView).isContinues()){
    		if(context != null){
