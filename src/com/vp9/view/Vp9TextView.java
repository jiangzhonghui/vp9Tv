...
public class Vp9TextView extends TextView {
	...
	public Vp9TextView(Context context) {
		super(context);
//		init(null);
	}
	public Vp9TextView(Context context, AttributeSet attrs) {
		super(context, attrs);
//		init(attrs);
	}
	public Vp9TextView(Context context, AttributeSet attrs, int defStyle) {
...
//
//		if(attrs != null){
//			TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.Vp9TextView);
//
//            String typefaceName = a.getString(R.styleable.Vp9TextView_typeface);
//            if(typefaceName != null) {
//                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("fonts/%s.ttf", typefaceName));
//                setTypeface(tf);
//            }
//            
//			if(a.hasValue(R.styleable.Vp9TextView_foreground)){
//				Drawable foreground = a.getDrawable(R.styleable.Vp9TextView_foreground);	
//				if(foreground != null){
//					this.setForegroundDrawable(foreground);
//				}else{
//					this.setTextColor(a.getColor(R.styleable.Vp9TextView_foreground, 0xff000000));
//				}
//			}
//
//			if(a.hasValue(R.styleable.Vp9TextView_background)){
//				Drawable background = a.getDrawable(R.styleable.Vp9TextView_background);
//				if(background != null){
//					this.setBackgroundDrawable(background);
//				}else{
//					this.setBackgroundColor(a.getColor(R.styleable.Vp9TextView_background, 0xff000000));
//				}
//			}
//
//			if(a.hasValue(R.styleable.Vp9TextView_innerShadowColor)){
//				this.addInnerShadow(a.getFloat(R.styleable.Vp9TextView_innerShadowRadius, 0), 
//									a.getFloat(R.styleable.Vp9TextView_innerShadowDx, 0), 
//									a.getFloat(R.styleable.Vp9TextView_innerShadowDy, 0),
//									a.getColor(R.styleable.Vp9TextView_innerShadowColor, 0xff000000));
//			}
//
//			if(a.hasValue(R.styleable.Vp9TextView_outerShadowColor)){
//				this.addOuterShadow(a.getFloat(R.styleable.Vp9TextView_outerShadowRadius, 0), 
//									a.getFloat(R.styleable.Vp9TextView_outerShadowDx, 0), 
//									a.getFloat(R.styleable.Vp9TextView_outerShadowDy, 0),
//									a.getColor(R.styleable.Vp9TextView_outerShadowColor, 0xff000000));
//			}
//
//			if(a.hasValue(R.styleable.Vp9TextView_strokeColor)){
//				float strokeWidth = a.getFloat(R.styleable.Vp9TextView_strokeWidth, 1);
//				int strokeColor = a.getColor(R.styleable.Vp9TextView_strokeColor, 0xff000000);
//				float strokeMiter = a.getFloat(R.styleable.Vp9TextView_strokeMiter, 10);
//				Join strokeJoin = null;
//				switch(a.getInt(R.styleable.Vp9TextView_strokeJoinStyle, 0)){
