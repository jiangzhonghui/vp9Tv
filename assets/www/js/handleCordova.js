...
/*get Free Space SDcard*/
VP9.cordova.getFreeSpaceSdcard = function(callbackSuccess, callbackError) {
    cordova.exec(callbackSuccess, callbackError, "HandlerEventPlugin", "getFreeSpaceSdcard", []);
}
...
function handlerCordovaMsg(message){
    console.log("handlerCordovaMsg: " + message );
