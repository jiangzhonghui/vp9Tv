...
#define FFMPEG_CONFIGURATION "--target-os=linux --arch=arm --enable-cross-compile --cross-prefix=arm-linux-androideabi- --enable-shared --disable-symver --disable-doc --disable-ffplay --enable-ffmpeg --disable-ffprobe --disable-ffserver --disable-demuxer=sbg --disable-demuxer=dts --disable-parser=dca --disable-decoder=dca --enable-asm --enable-version3 --prefix=/home/vietcv/FFmpeg-Android/build/ffmpeg/armv7 --extra-cflags='-O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -D__ARM_ARCH_5__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5TE__ -DANDROID -DNDEBUG -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp' --extra-ldflags='-Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2014
#define FFMPEG_DATADIR "/home/vietcv/FFmpeg-Android/build/ffmpeg/armv7/share/ffmpeg"
#define AVCONV_DATADIR "/home/vietcv/FFmpeg-Android/build/ffmpeg/armv7/share/ffmpeg"
